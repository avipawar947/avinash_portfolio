...
/**
 * A single process step — Figma nodes 1:192, 1:194, 1:196 and siblings.
 *
 ...
 *
 * `absolute` is opt-out so the same pill serves the desktop table (where
 * the design positions each one explicitly) and the narrow-screen stack
 * (where they simply follow one another).
 */
