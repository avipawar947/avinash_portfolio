...
export async function getHomeContent(): Promise<HomeContent> {
  try {
    ...
    const [hero, navbar, clientLogos, projects, process, gallery, stats, journey, lifeBehindText, tools, footer, settings] =
      await Promise.all([
    ...
    return {
      ...
      clientLogos: clientLogos?.length ? (clientLogos as any) : seedContent.clientLogos,
      ...
      lifeBehindText: lifeBehindText?.length ? (lifeBehindText as any) : seedContent.lifeBehindText,
