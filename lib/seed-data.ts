...
export const seedContent: HomeContent = {
  ...
  tools: [
    { _id: 't1', name: 'Adobe XD', iconKey: 'xd', iconUrl: '/icons/tools/xd.svg', left: 0, top: 5, iconSize: 60, iconLeft: 17, iconTop: 17, order: 0 },
    { _id: 't2', name: 'Adobe Photoshop', iconKey: 'photoshop', iconUrl: '/icons/tools/photoshop.svg', left: 4, top: 326, iconSize: 60, iconLeft: 17, iconTop: 17, order: 1 },
    { _id: 't3', name: 'LottieFiles', iconKey: 'lottiefiles', iconUrl: '/icons/tools/lottiefiles.svg', left: 67, top: 179, iconSize: 43, iconLeft: 24, iconTop: 25, order: 2 },
    { _id: 't4', name: 'Figma', iconKey: 'figma', iconUrl: '/icons/tools/figma.svg', left: 302, top: 0, iconSize: 60, iconLeft: 17, iconTop: 17, order: 3 },
    { _id: 't5', name: 'Adobe Illustrator', iconKey: 'illustrator', iconUrl: '/icons/tools/illustrator.svg', left: 367, top: 391, iconSize: 60, iconLeft: 17, iconTop: 17, order: 4 },
    { _id: 't6', name: 'Notion', iconKey: 'notion', iconUrl: '/icons/tools/notion.svg', left: 965, top: 391, iconSize: 60, iconLeft: 17, iconTop: 17, order: 5 },
    { _id: 't7', name: 'Claude', iconKey: 'claude', iconUrl: '/icons/tools/claude.svg', left: 1020, top: 0, iconSize: 45, iconLeft: 24, iconTop: 25, order: 6 },
    { _id: 't8', name: 'Magnific', iconKey: 'magnific', iconUrl: '/icons/tools/magnific.svg', left: 1255, top: 179, iconSize: 45, iconLeft: 25, iconTop: 24, order: 7 },
    { _id: 't9', name: 'Slack', iconKey: 'slack', iconUrl: '/icons/tools/slack.svg', left: 1316, top: 325, iconSize: 60, iconLeft: 17, iconTop: 17, order: 8 },
    { _id: 't10', name: 'OpenAI', iconKey: 'openai', iconUrl: '/icons/tools/openai.svg', left: 1322, top: 5, iconSize: 60, iconLeft: 17, iconTop: 17, order: 9 },
  ],
  footer: {
