...
export const seedContent: HomeContent = {
  ...
  process: [
    ...
    { _id: 'd2', phase: 'Discover', label: 'User & market research', order: 1 },
    { _id: 'd3', phase: 'Discover', label: 'UX audit of the existing product', order: 2 },
    { _id: 'f1', phase: 'Define', label: 'Defining concept and strategy', order: 0 },
    { _id: 'f2', phase: 'Define', label: 'Information architecture', order: 1 },
    { _id: 'f3', phase: 'Define', label: 'User journeys & flows', order: 2 },
    { _id: 'v1', phase: 'Deliver', label: 'Visual experience design, wireframing & design systems', order: 0 },
    { _id: 'v2', phase: 'Deliver', label: 'Usability testing, feedback & iteration', order: 1 },
    { _id: 'v3', phase: 'Deliver', label: 'Handoff & developer QA', order: 2 },
  ],
  ...
  journey: {
    heading: 'My Journey',
    lines: [
      { text: 'The journey started with a strong foundation in technology through BCA and MCA,', opacity: 1 },
